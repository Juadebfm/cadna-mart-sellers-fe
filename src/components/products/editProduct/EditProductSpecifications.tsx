...
interface Props {
  ...
  onSpecChange: (index: number, field: "attribute" | "value", value: string) => void;
}

export default function EditProductSpecifications({
  specs,
  onAddSpec,
  onRemoveSpec,
  onSpecChange,
  ...
  return (
    <div className="bg-white rounded-xl border border-[#E5E7EB] px-5 py-5">
      ...
      <div className="space-y-3">
        ...
        {specs.map((spec, i) => (
          <div key={i} className="flex flex-col sm:grid sm:grid-cols-2 gap-2 sm:gap-3">
            <div>
