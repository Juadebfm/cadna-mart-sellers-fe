    ...
    <div className="bg-[#FAFAFF] min-h-screen">
      <div className="flex flex-col items-center py-10">
        ...
        <div className="flex items-center justify-center">
          ...
          <div className="w-12 sm:w-20 flex justify-center">
            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-[#5D5FEF] flex items-center justify-center text-white font-semibold border-2 border-[#E5E7FF] text-sm sm:text-base">
              3
            </div>
          </div>
